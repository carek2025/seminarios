...
model = torch.hub.load('ultralytics/yolov5','custom',
					   path = 'C:/Users/Carlos Enrique/Desktop/seminarios/clase_8/exp13/weights/best.pt')
...
while True:
	...
	print(info)
	#Mostramos FPS
	cv2.imshow('Detector de animales especificamnete 4 --> rata, delfin, gato y oso',np.squeeze(detect.render()))
